...
public class BuilderEntityLinkedSeat extends ABuilderEntityBase {
    public static EntityType<BuilderEntityLinkedSeat> E_TYPE3;
    ...
    public BuilderEntityLinkedSeat(EntityType<? extends BuilderEntityLinkedSeat> eType, Level world) {
        super(BuilderEntityLinkedSeat.E_TYPE3, world);
    }
    ...
    //Note: the Forge shouldRiderSit() override is dropped on Fabric.  The rider's leg/arm
    //pose for standing seats is driven entirely by HumanoidModelMixin (renderCurrentRiderStanding),
    //so this override is redundant here.
