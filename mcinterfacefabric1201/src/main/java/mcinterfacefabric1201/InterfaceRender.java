...
public class InterfaceRender implements IInterfaceRender {
    ...
    /**
     * Called to setup the client.  We register our shaders and render wrapper
     * classes here.
     */
    public static void initClient() {
        //Register our custom shaders.
        CoreShaderRegistrationCallback.EVENT.register(context -> {
            try {
                context.register(new ResourceLocation(InterfaceLoader.MODID, "mts_entity_lights"), DefaultVertexFormat.NEW_ENTITY, (createdShader) -> entityLightsShader = createdShader);
                context.register(new ResourceLocation(InterfaceLoader.MODID, "mts_entity_cutout_noshadows"), DefaultVertexFormat.NEW_ENTITY, (createdShader) -> entityCutoutNoshadowsShader = createdShader);
            } catch (IOException e) {
        ...
        EntityRendererRegistry.register(BuilderEntityRenderForwarder.E_TYPE4, manager -> new EntityRenderer<BuilderEntityRenderForwarder>(manager) {
            @Override
        ...
        EntityRendererRegistry.register(BuilderEntityExisting.E_TYPE2, manager -> new BlankRender<BuilderEntityExisting>(manager));
        EntityRendererRegistry.register(BuilderEntityLinkedSeat.E_TYPE3, manager -> new BlankRender<BuilderEntityLinkedSeat>(manager));
    }
